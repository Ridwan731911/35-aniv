      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-pink-100 text-base md:text-lg leading-relaxed mb-6">
            Selemat anniversary yang ke tiga puluhh lima syangg aku.
            Alhamdulillah yaa yang kitaa bisaa melewati semua hal sulit bareng-bareng.
            Ramai sepii kita selalu bersama... (dst)
          </p>

          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={() => window.location.href = "/Ucapan2"}
