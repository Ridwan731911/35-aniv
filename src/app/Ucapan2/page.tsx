            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-pink-100 text-base md:text-lg leading-relaxed mb-6">
                  Harapan dan Doa ku buat kita. Semoga kita baik baik terus
                  lebih langgeng tak marah marah makin cintaa makin sayang
                  jangan berantem berantem teruss.
                </p>

                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  onClick={() => (window.location.href = "/Ucapan3")}
